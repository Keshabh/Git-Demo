...
2. Then in terminal, enter **${{\color{green}code\ .}}$**, it opens the project in vs code.
...
6. if a folder contains index.html file, then **${{\color{yellow}git \ add\ index.html}}$** adds index.html to the staging area.
